...
if (isset($_POST['subm']))
{
  ...
  $old_ID=$_POST['old_ID'];
  $result1=mysqli_query($conn,"SELECT * FROM payrols.employee WHERE ID='".$old_ID."'limit 1");
  if (mysqli_num_rows($result1)==1)
  {
   $update= "update payrols.employee set ID='$ID',NAME='$NAME',ADDRESS='$ADDRESS',RANK='$RANK',HOURS_WORKED='$HOURS_WORKED',OVERTIME_HOURS='$OVERTIME_HOURS'where ID='$old_ID'";
  $result2=mysqli_query($conn,$update);
    echo "<p style='color:green'>the username and password updated</p>";
  }
...
<body>
	<form method="post">
    enter old ID <input type="text" name="old_ID">
